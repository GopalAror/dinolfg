    ...
    return (
        <div className='relative overflow-x-clip'>
            ...
            <div className="max-w-[1064px] px-3 mx-auto">
                <h2 className='text-white text-center font-chewy font-normal sm:text-[48px] text-[30px] md:text-[64px] leading-[83px] pb-[20px] relative z-[1] sm:pb-[158px]'>Utility and Usecase</h2>
                <div className="border relative z-[2] bg-[#09655A] border-white rounded-[20px] max-w-[1014px] min-h-[221px] mx-auto" data-aos="fade-right">
